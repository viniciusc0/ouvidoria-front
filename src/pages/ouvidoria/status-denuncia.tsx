...
function StatusDenunciaPage() {
    ...
    return (
        <>
            ...
            <Grid container lg={8} xs={12} sx={{ margin: '80px auto 0 auto' }}>
                <Card
                    sx={{
                        textAlign: 'center',
                        display: 'flex',
                ...
                >
                    ...
                    <Typography variant="body1">
                        Insira o número de protocolo no campo abaixo para verificar o status do relato ou enviar novas
                        evidências para o comitê. Através do número de protocolo é possível acompanhar todo o processo
                        de tratamento do seu relato.
                    </Typography>
                    <TextField
